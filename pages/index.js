  ...
  return (
    <>
      ...
      <div className="w-full">
        <Head>
          <title>SofaHub</title>
          <meta name="description" content="SofaHub ECommercel Next provides a way to quickly get up and running with a fully configurable ECommerce site using Next.js." />
          <meta property="og:title" content="SofaHub ECommerce" key="title" />
        </Head>
